...
public class Kakasi {
    ...
    public void setInputFileMode(boolean inputFileMode) {
        this.inputFileMode = inputFileMode;
    }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        for (; index < args.length; index++) {
            if (kakasi.isInputFileMode()) {
                kakasi.input.setReader(new FileReader(args[index]));
            }
        }
        kakasi.run();
